    ...
    <section className="py-20 bg-[#F5F5F5] border-t border-black/5">
      <div className="w-full px-4 sm:px-6 lg:px-10 xl:px-16">
        <FadeUp className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-[#0A0A0A] mb-4">Proudly Serving the Inland Empire</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <FadeUp>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {siteConfig.serviceArea.map((city) => (
                <div key={city} className="flex items-center gap-2 text-black/60 text-sm">
          ...
          {/* Map embed */}
          <FadeUp delay={0.2}>
            <div className="rounded-xl overflow-hidden border border-black/10 h-72 lg:h-80">
              <iframe
