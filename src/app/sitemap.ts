...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${base}/services/luxury-car-wraps`, priority: 0.9, changeFrequency: "monthly" as const },
    ...
    { url: `${base}/services/utv-wraps`, priority: 0.85, changeFrequency: "monthly" as const },
    { url: `${base}/services/architectural-wraps`, priority: 0.8, changeFrequency: "monthly" as const },
    { url: `${base}/services/branding-graphic-design`, priority: 0.9, changeFrequency: "monthly" as const },
