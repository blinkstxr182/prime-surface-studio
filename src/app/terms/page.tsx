  ...
  return (
    <section className="py-20 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-16">
        <FadeUp>
          <h1 className="text-4xl font-black text-[#0A0A0A] mb-3">Terms of Service</h1>
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-black/70 leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">1. Services</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">2. Quotes &amp; Pricing</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">3. Deposits &amp; Payment</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">4. Warranties</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">5. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">6. California Law &amp; Compliance</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0A0A0A]">7. Contact</h2>
              <p>
